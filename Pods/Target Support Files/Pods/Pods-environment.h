...
// Marvelous
#define COCOAPODS_POD_AVAILABLE_Marvelous
#define COCOAPODS_VERSION_MAJOR_Marvelous 0
#define COCOAPODS_VERSION_MINOR_Marvelous 7
#define COCOAPODS_VERSION_PATCH_Marvelous 3
